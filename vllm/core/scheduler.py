...
from vllm.core.block import BLOCK_SIZE, compute_blocks
from vllm.core.sequence import SequenceStatus, Sequence
...
class Scheduler:
    ...
    def _handle_preemption(self, outputs):
        ...
        while not self.block_manager.can_allocate(blocks_for_waiting) and self.running:  #while block only runs if both conditions are true
